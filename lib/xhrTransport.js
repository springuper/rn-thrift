...
TXHRTransport.prototype = {
   ...
   * @param {boolean} async - If true the current send buffer is returned.
  ...
  flush: function(async, callback) {
    ...
    if (xreq.overrideMimeType) {
      xreq.overrideMimeType('application/x-thrift; charset=utf-8');
    }
    ...
    if (xreq.setRequestHeader) {
      xreq.setRequestHeader('Accept', 'application/x-thrift; charset=utf-8');
      xreq.setRequestHeader('Content-Type', 'application/x-thrift; charset=utf-8');
    }
